...
<div class="month-nav" id="duesTableMonthNav">
    <button class="btn btn-sm btn-secondary mn-prev" onclick="MonthNav.prev('duesTable')" title="Previous month">
    ...
    <button class="btn btn-sm btn-secondary mn-next" onclick="MonthNav.next('duesTable')" title="Next month">
...
document.addEventListener('DOMContentLoaded',function(){init();MonthNav.init('duesTable','duesTableMonthNav');});
})();
</script>
